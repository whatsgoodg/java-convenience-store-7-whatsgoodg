...
class PromotionFileLoaderTest {
    ...
    void 파일에서_객체생성_테스트(){
        //given
        Promotion promotion1 = new Promotion("탄산2+1", 2, 1, LocalDate.parse("2024-01-01"), LocalDate.parse("2024-12-31"));
        Promotion promotion2 = new Promotion("null", 1, 1, LocalDate.parse("2024-01-01"), LocalDate.parse("2024-01-01"));
        //when
